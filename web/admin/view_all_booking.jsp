...
<table class="table table-striped mx-3 mr-3">
  <thead>
    ...
    <%
        ...
        ArrayList al = db.view_all_user_bookings();
        int count =0;
  ...
  <thead>
    ...
    <%
        ...
        ArrayList ai = db.get_all_booked_services(0);
        int order =0;
  ...
  <tbody>
    <tr>
      ...
      <td>
          <form method='post' action='${pageContext.request.contextPath}/completed_service'>
      
              <input type="hidden" value="<%=data[4]%>" name="username"/>
